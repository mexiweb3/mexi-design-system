...
Make AI-native operations practical for Spanish-speaking businesses, and document the building process publicly so others can replicate it.
...
- Spanish-speaking Web3 community
- Followers across X, Instagram, TikTok, YouTube
- Vibecodeando Ando viewers
- BandaWeb3 Spaces listeners

**Jobs-to-be-done**
- Find every project / channel / link in one place
- Join the community (WhatsApp, Telegram, X)
...
- 22-35, Mexican / latam, junior-mid dev or product person
- Active on X, follows AI/crypto builders
- Wants to learn by watching others build
- Already knows the @meximalist handle
- Joins communities, comments, shares
...
- We do not optimize for SEO of generic terms ("AI consulting")
...
## 11. Decision principles for design
